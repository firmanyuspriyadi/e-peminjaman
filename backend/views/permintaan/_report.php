...
<table class="table table-striped table-bordered" width="1321" border="0">
    <tbody>
        <tr>
            <th width="300" style="text-align: left; font-size: 22px">Telah terima dari</th>
            <th style="text-align: left; font-size: 18px">: <?php echo Yii::$app->user->identity->nama;?></th>           
        </tr>
        <tr>
            <th width="300" style="text-align: left; font-size: 22px">Untuk keperluan</th>
            <th style="text-align: left; font-size: 18px">: <?php echo $model->keperluan;?>
        </tr>
...
<table class="table table-striped table-bordered" width="1321" border="0">
    <tbody>
        ...
        <tr>
            ...
            <th>&nbsp;</th>
            <th  width="200" style="text-align: left; font-size: 16px"><font face="Arial, Helvetica, sans-serif">Nama     : <?php echo Yii::$app->user->identity->nama;?></font></th>
       
            <th width="200" style="text-align: left; font-size: 16px"><font face="Arial, Helvetica, sans-serif">Nama     : <?php echo $model->pemohon;?></font></th>
