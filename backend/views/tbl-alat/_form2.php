...
<div class="tbl-alat-form">
   ...
   <?php $form = ActiveForm::begin(['id' => 'dynamic-form']); ?>
     ...
     <?=  $form->field($model, 'id_kat_alat')->widget(Select2::classname(), [
        ...
        'language' => 'en',
       //'options' => ['multiple'=>true,'placeholder' => 'Pilih Kategori ...'],  
        'options'=>['id'=>'kat-id'],
        'pluginOptions' => [
     ...
     <?=  $form->field($model, 'id_model_alat')->widget(Select2::classname(), [
        'data' => ArrayHelper::map(TblModelAlat::find()->all(),'id','nama_model'),
        'language' => 'en',
    ...
    <?= $form->field($model, 'nm_alat')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'no_seri')->textInput(['maxlength' => true]) ?>
    
    <?= $form->field($model, 'tgl_terima')->textInput() ?>

    <?= $form->field($model, 'tahun_buat')->textInput(['maxlength' => true]) ?>
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?= $form->field($part, "[{$i}]no_seri_part")->textInput(['maxlength' => true]) ?>
                            </div>
                            <div class="col-sm-6">
                                <?= $form->field($part, "[{$i}]tahun_buat")->textInput(['maxlength' => true]) ?>
                            </div>
